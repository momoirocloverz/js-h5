    ...
    <div class="listCon marBottom30">
      <template v-for="(item, index) in state.formData.firstTable" :key="index">
        <div class="marBottom30 itemCon">
          ...
          <div class="itemContent marBottom30">
            <div class="inputMatchTitle marBottom20">建设地点</div>
            <input v-model.trim="state.formData.firstTable[index].location" maxlength="100" @input="fieldChange" :disabled="Route.query.justForShow == 1" placeholder="请输入建设地点" />
          </div>
          <div class="itemContent marBottom30">
            <div class="inputMatchTitle marBottom20">建设单位</div>
            <input v-model.trim="state.formData.firstTable[index].declare_unit" maxlength="100" @input="fieldChange" :disabled="Route.query.justForShow == 1" placeholder="请输入建设单位" />
          </div>
          <div class="itemContent marBottom30">
    ...
    <div class="listCon marBottom30">
      <template v-for="(item, index) in state.formData.secondTable" :key="index">
        <div class="marBottom30 itemCon">
          ...
          <div class="itemContent marBottom30">
            <div class="inputMatchTitle marBottom20">建设地点</div>
            <input v-model.trim="state.formData.secondTable[index].location" maxlength="100" @input="fieldChange" :disabled="Route.query.justForShow == 1" placeholder="请输入建设地点" />
          </div>
          <div class="itemContent marBottom30">
            <div class="inputMatchTitle marBottom20">建设单位</div>
            <input v-model.trim="state.formData.secondTable[index].declare_unit" maxlength="100" @input="fieldChange" :disabled="Route.query.justForShow == 1" placeholder="请输入建设单位" />
          </div>
          <div class="itemContent marBottom30">
            <div class="inputMatchTitle marBottom20">规模（数量）</div>
    ...
    <div class="listCon marBottom30">
      <template v-for="(item, index) in state.formData.thirdTable" :key="index">
        <div class="marBottom30 itemCon">
          ...
          <div class="itemContent marBottom30">
            <div class="inputMatchTitle marBottom20">建设地点</div>
            <input v-model.trim="state.formData.thirdTable[index].location" maxlength="100" @input="fieldChange" placeholder="请输入建设地点" :disabled="Route.query.justForShow == 1" />
          </div>
          <div class="itemContent marBottom30">
            <div class="inputMatchTitle marBottom20">建设单位</div>
            <input v-model.trim="state.formData.thirdTable[index].declare_unit" maxlength="100" @input="fieldChange" placeholder="请输入建设单位" :disabled="Route.query.justForShow == 1" />
          </div>
          <div class="itemContent marBottom30">
            <div class="inputMatchTitle marBottom20">规模（数量）</div>
    ...
    <div class="fixPaddingBottom">
      ...
      <div v-else>
        <div class="fixBottom fixPaddingBottom" v-if="Route.query.status == 2">
          ...
          <van-button class="submitBtn" block type="primary" @click="finish" :class="state.ZLBFitForOld ? 'btnTextOld' : ''">完成</van-button>
        </div>
