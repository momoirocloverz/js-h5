<!-- 粮油补贴申请 -->
<template>
  <BeeProgress activeStep="3" :textList="['基本信息', '种植信息', '材料填写']"></BeeProgress>
  <div class="help-farmer-container" :class="{ 'fit-old': ZLBFitForOld }">
    <div class="panel">
      <div class="form-conatiner">
        ...
        <van-form @submit="onSubmit" @failed="onFailed" :disabled="status > 0" label-width="140" validate-trigger="onSubmit" ref="acForm">
          ...
          <AcUploader :fileList="cnsFileList" title="1.粮油生产经营主体承诺书" :witchType="71" @deleteCb="getData" @choiceImg="choiceImg" :status="status"></AcUploader>
          <AcUploader :fileList="lzhtFileList" title="2.种植区域农村土地承包经营权委托流转合同" :witchType="72" @deleteCb="getData" @choiceImg="choiceImg" :status="status"></AcUploader>
          <AcUploader :fileList="lzqcFileList" title="3.种植区域耕地承包流转清册" :witchType="73" @deleteCb="getData" @choiceImg="choiceImg" :status="status"></AcUploader>
          <AcUploader :fileList="sytFileList" title="4.种植区域分布示意图（现状图）" :witchType="74" @deleteCb="getData" @choiceImg="choiceImg" :status="status"></AcUploader>
          <AcUploader :fileList="zfpzFileList" title="5.大田租金支付凭证或分户支付清册" :witchType="75" @deleteCb="getData" @choiceImg="choiceImg" :status="status"></AcUploader>
        </van-form>
      </div>
    </div>
    <!-- 审核流程 -->
    <div class="panel approval-process">
      ...
      <BreakApprovalSteps :status="status" :approvalData="approvalData" :processData="processData" :finalStatus="8"></BreakApprovalSteps>
    </div>
    <div class="bottom-btn" v-if="status != 82">
    ...
    const state = reactive({
      ...
      processData: {
        ...
        1: {
          title: '公示（所在村）',
          at: 'ly_cun_public_at',
          not_at: 'ly_cun_public_not_at',
          reason: 'ly_cun_public_reason',
          attachment: 'ly_cun_public_attachment',
          attachment_doc: 'ly_cun_public_attachment_doc'
        },
        2: {
          title: '村级人员审核',
          at: 'ly_cun_audit_at',
          not_at: 'ly_cun_audit_not_at',
          reason: 'ly_cun_audit_reason',
          attachment: 'ly_cun_audit_attachment',
          attachment_doc: 'ly_cun_audit_attachment_doc'
        },
        // 3: {
        //   title: '乡镇农技中心审核',
        //   at: 'ly_village_njzx_at',
        //   not_at: 'ly_village_njzx_not_at',
        //   reason: 'ly_village_njzx_reason',
        //   attachment: 'ly_village_njzx_attachment',
        //   attachment_doc: 'ly_village_njzx_attachment_doc',
        // },
        // 4: {
        //   title: '乡镇农技中心领导审核',
        //   at: 'ly_village_audit_at',
        //   not_at: 'ly_village_audit_not_at',
        //   reason: 'ly_village_audit_reason',
        //   attachment: 'ly_village_audit_attachment',
        //   attachment_doc: 'ly_village_audit_attachment_doc',
        // },
        // 5: {
        //   title: '农业农村局审核',
        //   at: 'ly_rural_audit_at',
        //   not_at: 'ly_rural_audit_not_at',
        //   reason: 'ly_rural_audit_reason',
        //   attachment: 'ly_rural_audit_attachment',
        //   attachment_doc: 'ly_rural_audit_attachment_doc',
        // },
        // 6: {
        //   title: '第三方公司核查',
        //   at: 'ly_three_company_at',
        //   not_at: 'ly_three_company_not_at',
        //   reason: 'ly_three_company_reason',
        //   attachment: 'ly_three_company_attachment',
        //   attachment_doc: 'ly_three_company_attachment_doc',
        // },
        // 7: {
        //   title: '公示（政府网）',
        //   at: 'ly_public_govn_at',
        //   not_at: 'ly_public_govn_not_at',
        //   reason: 'ly_public_govn_reason',
        //   attachment: 'ly_public_govn_attachment',
        //   attachment_doc: 'ly_public_govn_attachment_doc',
        // },
        // 8: {
        //   title: '资金拨付',
        //   at: 'ly_fund_at',
        //   not_at: 'ly_fund_not_at',
        //   real_fund_amount: 'real_fund_amount',
        //   reason: 'ly_fund_reason',
        //   attachment: 'ly_fund_attachment',
        //   attachment_doc: 'ly_fund_attachment_doc',
        // },
        3: {
          title: '乡镇街道审核',
          at: 'ly_village_njzx_at',
