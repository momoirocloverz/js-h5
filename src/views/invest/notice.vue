    ...
    <div class="masterInner">
      <div class="title">
        <div class="homeTag marBottom20">
          <div class="tagText">{{ state.detail.zysx_title }}</div>
        </div>
      </div>
      <div class="timeCon">
      ...
      <div class="contentCon">
        <div v-html="state.detail.zysx_content" class="con"></div>
      </div>
    </div>
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const fetchList = () => {
      Request.investBsydGetInfo({ invest_category_id: Route.query.invest_category_id })
        .then((res) => {
          if (res && res.code == 0) {
